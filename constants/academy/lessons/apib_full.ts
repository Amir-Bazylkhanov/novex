// ============================================
// Учебный контент планеты «AP / IB Classes» (подготовка к программам
// AP/IB) — готовый учебный курс Академии Novex.
// Подключается в constants/academy/catalog.ts как одна из
// планет и показывается на странице /learn для соответствующего
// робота-наставника.
// Одна запись = один класс (ключ вида "AP / IB Classes_8"..._12): введение +
