// ============================================
// Учебный контент планеты «Productivity & Learning Systems» (продуктивность
// и системы обучения) — готовый учебный курс Академии Novex.
// Подключается в constants/academy/catalog.ts как одна из
// планет и показывается на странице /learn для соответствующего
// робота-наставника.
// Одна запись = один класс (ключ вида
// "Productivity & Learning Systems_8"..._12): введение + список секций, где
// у каждой секции — теория на трёх языках, формулы, термины, разобранные
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Повторяйте в День 1 (вт), День 3 (чт), День 7 (следующий пн), День 21 (через три недели). Каждая сессия занимает меньше времени по мере укрепления памяти.",
            answerKk: "1-күні (сс), 3-күні (бс), 7-күні (келесі дс), 21-күні (үш аптадан кейін) қайталаңыз. Жады нығайған сайын әр сессия аз уақыт алады."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Повторение материала с увеличивающимися интервалами непосредственно перед тем, как вы его забудете, что укрепляет долговременную память.",
            answerKk: "Материалды ұмытар алдында арта беретін аралықтармен қайталау, бұл ұзақ мерзімді жадыны нығайтады.",
          ...
          },
          {
            ...
            answerRu: "Разделите на 4 группы по 15 дат. Учите Группу 1 на 1-й неделе, Группу 2 на 2-й неделе и т. д. Повторяйте каждую группу через 1, 3, 7 и 21 день. Более ранние группы получают больше циклов повторения до экзамена.",
            answerKk: "15 күннен тұратын 4 топқа бөліңіз. 1-топты 1-аптада, 2-топты 2-аптада үйреніңіз және т.б. Әр топты 1, 3, 7 және 21 күн аралығында қайталаңыз. Ертерек топтар емтиханға дейін көбірек қайталау циклін алады.",
          ...
          },
          {
            ...
            answerRu: "Побеждает подход с 6 сессиями. Общее время то же самое (3 часа), но интервальная практика использует кривую забывания — каждое воспроизведение укрепляет память. Зубрёжка создаёт кратковременное запоминание, которое исчезает за несколько дней, тогда как интервальное повторение формирует прочную долговременную память.",
            answerKk: "6 сессиялық тәсіл жеңеді. Жалпы уақыт бірдей (3 сағат), бірақ аралықты жаттығу ұмыту қисығын тиімді пайдаланады — әр еске түсіру жадыны нығайтады. Жаттау бірнеше күнде жоғалатын қысқа мерзімді есте сақтауды тудырады, ал аралықты қайталау берік ұзақ мерзімді жады қалыптастырады.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Закройте книгу, напишите по памяти, сверьте с текстом, повторно проверьте пробелы. Повторяйте, пока не сможете полностью воспроизвести ключевые понятия по памяти.",
            answerKk: "Кітапты жабыңыз, жадыдан жазыңыз, мәтінмен салыстырыңыз, олқылықтарды қайта тексеріңіз. Негізгі ұғымдарды жадыдан толық қайта шығара алғанша қайталаңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Активное воспроизведение заставляет мозг извлекать информацию, укрепляя нейронные пути. Перечитывание создаёт ложное чувство знакомости, не проверяя память на самом деле.",
            answerKk: "Белсенді еске түсіру миды ақпаратты алуға мәжбүрлеп, нейрондық жолдарды нығайтады. Қайта оқу жадыны нақты тексермей, жалған таныстық сезімін тудырады.",
          ...
          },
          {
            ...
            answerRu: "Разделите на 4 группы по 10. Изучите Группу 1, затем закройте список и напишите переводы по памяти. Проверьте и отметьте ошибки. Повторяйте только ошибки. Переходите к Группе 2. После всех групп проведите общий тест по всем 40 словам.",
            answerKk: "10 сөзден тұратын 4 топқа бөліңіз. 1-топты үйреніңіз, содан кейін тізімді жауып, аудармаларды жадыдан жазыңыз. Тексеріп, қателерді белгілеңіз. Тек қателерді қайталаңыз. 2-топқа өтіңіз. Барлық топтардан кейін 40 сөздің бәріне жалпы тест өткізіңіз.",
          ...
          },
          {
            ...
            answerRu: "Замените выделение текста созданием вопросов: после каждого раздела пишите 3-5 вопросов. Замените перечитывание самопроверкой: закройте конспект и ответьте на собственные вопросы. Используйте воспроизведение на чистом листе после каждой сессии. Создавайте практические тесты в формате экзамена. Занимайтесь с партнёром, опрашивая друг друга.",
            answerKk: "Мәтінді бөлектеуді сұрақтар құрумен ауыстырыңыз: әр бөлімнен кейін 3-5 сұрақ жазыңыз. Қайта оқуды өзін-өзі тексерумен ауыстырыңыз: конспектіні жауып, өз сұрақтарыңызға жауап беріңіз. Әр сабақтан кейін таза парақта еске түсіруді қолданыңыз. Емтихан форматын қайталайтын жаттығу тесттерін жасаңыз. Серіктеспен бірге бір-біріңізді сұрап оқыңыз.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Напишите простое объяснение, определите, где вы застреваете или используете жаргон, изучите эти пробелы, затем переписывайте, пока объяснение не станет понятным ребёнку.",
            answerKk: "Қарапайым түсіндірме жазыңыз, қай жерде тұрып қалатыныңызды немесе жаргон қолданатыныңызды анықтаңыз, сол олқылықтарды зерттеңіз, содан кейін түсіндірме балаға түсінікті болғанша қайта жазыңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Выявить пробелы в понимании, пытаясь объяснить концепцию простыми словами, а затем заполнить эти пробелы.",
            answerKk: "Тұжырымдаманы қарапайым сөздермен түсіндіруге тырысу арқылы түсінігіңіздегі олқылықтарды анықтап, содан кейін оларды толтыру.",
          ...
          },
          {
            ...
            answerRu: "Процессор — это как супербыстрый калькулятор, который выполняет инструкции одну за другой. Он извлекает инструкцию (например, «сложить 2+3»), выполняет вычисление и сохраняет результат — миллиарды раз в секунду. Если вы не можете просто объяснить цикл «извлечение-декодирование-выполнение», это ваш пробел для изучения.",
            answerKk: "Процессор — нұсқауларды бірінен соң бірін орындайтын өте жылдам калькулятор сияқты. Ол нұсқауды алады (мысалы, «2+3-ті қосу»), есептеуді орындайды және нәтижені сақтайды — секундына миллиардтаған рет. «Алу-декодтау-орындау» циклін қарапайым түсіндіре алмасаңыз, бұл сіздің оқитын олқылығыңыз.",
          ...
          },
          {
            ...
            answerRu: "Пример: тема — естественный отбор. Первая попытка: «Животные, подходящие своей среде, выживают и рожают детёнышей». Найденные пробелы: а как насчёт генетической изменчивости? Что вызывает мутации? После изучения улучшенный вариант: «Случайные генетические мутации создают изменчивость. Особи с признаками, подходящими среде, дольше выживают и больше размножаются, передавая эти признаки. Через поколения популяция меняется».",
            answerKk: "Мысал: тақырып — табиғи сұрыпталу. Алғашқы әрекет: «Ортасына сай жануарлар аман қалып, балалы болады». Табылған олқылықтар: генетикалық өзгергіштік ше? Мутацияларды не тудырады? Зерттегеннен кейін жақсартылған нұсқа: «Кездейсоқ генетикалық мутациялар өзгергіштік тудырады. Ортасына сай белгілері бар дарақтар ұзағырақ өмір сүріп, көбірек көбейеді, сол белгілерді ұрпаққа береді. Ұрпақтар бойы популяция өзгереді».",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Центр: Вторая мировая война. Пять цветных ветвей (Причины, Битвы, Лидеры, Тыл, Итоги), каждая с 3-4 ключевыми подветвями и простыми иконками.",
            answerKk: "Орталық: Екінші дүниежүзілік соғыс. Түспен белгіленген бес тармақ (Себептер, Шайқастар, Көшбасшылар, Тыл, Нәтижелер), әрқайсысында 3-4 негізгі сөзден тұратын ішкі тармақ пен қарапайым белгішелер."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Центральная тема, главные ветви для ключевых направлений, подветви для деталей, ключевые слова (не полные предложения), цвета, а также изображения или иконки.",
            answerKk: "Орталық тақырып, негізгі тақырыптарға арналған басты тармақтар, детальдарға арналған ішкі тармақтар, кілт сөздер (толық сөйлемдер емес), түстер және суреттер немесе белгішелер.",
          ...
          },
          {
            ...
            answerRu: "Центр: изменение климата. Ветви: причины (ископаемое топливо, вырубка лесов), последствия (уровень моря, погода), решения (возобновляемая энергия, политика), доказательства (данные, исследования). Каждая ветвь становится абзацем или разделом эссе.",
            answerKk: "Орталық: климат өзгерісі. Тармақтар: себептер (қазба отын, ормандарды кесу), салдарлар (теңіз деңгейі, ауа-райы), шешімдер (жаңартылатын энергия, саясат), дәлелдер (деректер, зерттеулер). Әр тармақ эссенің абзацы немесе бөлімі болады.",
          ...
          },
          {
            ...
            answerRu: "Ментальные карты отлично подходят для мозгового штурма, поиска связей между темами и повторения (например, планирование эссе, изучение широкой темы вроде экосистем). Линейные конспекты лучше для последовательных процессов, пошаговых процедур и подробных формул (например, доказательства в математике, алгоритмы программирования). Лучший подход: ментальные карты для общей картины, линейные конспекты для деталей.",
            answerKk: "Ойлау карталары ой шақыру, тақырыптар арасындағы байланыстарды көру және қайталау үшін тамаша (мысалы, эссе жоспарлау, экожүйе сияқты кең тақырыпты оқу). Сызықтық жазбалар кезекті процестерге, қадамдық процедураларға және егжей-тегжейлі формулаларға жақсырақ (мысалы, математикалық дәлелдемелер, бағдарламалау алгоритмдері). Ең жақсы тәсіл: жалпы шолу үшін ойлау карталарын, детальдар үшін сызықтық жазбаларды қолдану.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Уберите все отвлекающие факторы, поставьте конкретную цель для написания, работайте 90 минут без перерыва, затем сделайте восстанавливающий перерыв.",
            answerKk: "Барлық алаңдатушыларды алып тастаңыз, жазу үшін нақты мақсат қойыңыз, 90 минут үзіліссіз жұмыс істеңіз, содан кейін қалпына келтіретін үзіліс жасаңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Уведомления телефона — положите телефон в другую комнату. Соцсети — используйте блокировщик сайтов. Шумная обстановка — используйте наушники с шумоподавлением или найдите тихое место.",
            answerKk: "Телефон хабарландырулары — телефонды басқа бөлмеге қойыңыз. Әлеуметтік медиа — сайт бұғаттаушысын қолданыңыз. Шулы орта — шуды басатын құлақаспап қолданыңыз немесе тыныш орын табыңыз.",
          ...
          },
          {
            ...
            answerRu: "Первые 10 минут: перекус и подготовка рабочего места, телефон на беззвучный режим. Следующие 70 минут: глубокая работа над самой важной/сложной задачей. 10-минутный перерыв. Последние 20 минут: более лёгкие задачи (просмотр конспектов, организация материалов). 10 минут на переход к вечернему мероприятию.",
            answerKk: "Алғашқы 10 минут: тағамдану және жұмыс орнын дайындау, телефонды дыбыссыз қылу. Келесі 70 минут: ең маңызды/қиын тапсырмаға терең жұмыс. 10 минуттық үзіліс. Соңғы 20 минут: жеңілірек тапсырмалар (конспектілерді қарау, материалдарды реттеу). Кешкі іс-шараға көшу үшін 10 минут.",
          ...
          },
          {
            ...
            answerRu: "Проблема: скорее всего поверхностная работа — постоянная проверка телефона, переключение между задачами, музыка со словами, открытые соцсети. Перестройка: два 90-минутных блока глубокой работы с 30-минутным перерывом между ними. Телефон убран, для каждого блока конкретные цели, блокировщик сайтов активен. Оставшееся время — на повторение и лёгкие задачи. Общее сфокусированное время: 3 часа, но эффективнее, чем 5 часов рассеянной учёбы.",
            answerKk: "Мәселе: бәлкім, беткейлі жұмыс — телефонды үнемі тексеру, тапсырмалар арасында ауысу, сөзді музыка, ашық әлеуметтік медиа. Қайта құру: арасында 30 минуттық үзілісі бар екі 90 минуттық терең жұмыс блогы. Телефон жабулы, әр блокқа нақты мақсат, сайт бұғаттаушысы қосулы. Қалған уақыт — қайталау мен жеңіл тапсырмаларға. Жалпы фокусталған уақыт: 3 сағат, бірақ алаңдаулы 5 сағаттық оқудан тиімдірек.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Q1: подготовка к экзамену (сделать сейчас). Q2: исследование колледжей (запланировать). Q3: игры (вежливо отказаться). Q4: соцсети (устранить).",
            answerKk: "Q1: емтиханға дайындық (қазір орында). Q2: колледж зерттеуі (жоспарла). Q3: ойын (сыпайы бас тарт). Q4: әлеуметтік медиа (жой)."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Квадрант 2 (важно, но не срочно) — именно здесь происходит планирование, развитие навыков, укрепление отношений и профилактика. Инвестиции сюда снижают будущие кризисы.",
            answerKk: "2-квадрант (маңызды, бірақ шұғыл емес) — жоспарлау, дағды дамыту, қарым-қатынас нығайту және алдын алу дәл осы жерде болады. Осында инвестициялау болашақ дағдарыстарды азайтады.",
          ...
          },
          {
            ...
            answerRu: "Q1: ответ про домашнее задание (срочно + важно для учебного сотрудничества). Q2: подготовка к тесту и поступление в университет (важно, но пока не срочно — запланируйте). Q3: уборка стола (кажется продуктивным, но не по-настоящему важно). Q4: ничего не указано, но соцсети попали бы сюда.",
            answerKk: "Q1: үй тапсырмасы туралы жауап беру (шұғыл + оқу ынтымақтастығы үшін маңызды). Q2: тестке дайындық пен университетке түсу (маңызды, бірақ әлі шұғыл емес — жоспарлаңыз). Q3: үстелді реттеу (өнімді сезілгенімен шын мәнінде маңызды емес). Q4: тізімде жоқ, бірақ әлеуметтік медиа осында орналасар еді.",
          ...
          },
          {
            ...
            answerRu: "Неделя 1: занесите все предстоящие дедлайны семестра в календарь — видимость предотвращает кризисы. Неделя 2: начинайте каждое задание в день его выдачи, даже если всего на 15 минут. Неделя 3: выработайте привычку еженедельного обзора — планирование в воскресенье вечером на предстоящую неделю. Неделя 4: создайте расписание учёбы со встроенными резервами времени, чтобы ничего не превращалось в аврал. Со временем меньше задач будет попадать в Q1, потому что они решаются в Q2.",
            answerKk: "1-апта: семестрдің барлық алдағы мерзімдерін күнтізбеге жазыңыз — көрінерлік дағдарыстардың алдын алады. 2-апта: әр тапсырманы берілген күні бастаңыз, тіпті тек 15 минутқа болса да. 3-апта: апта сайынғы шолу дағдысын қалыптастырыңыз — жексенбі кешінде алдағы аптаны жоспарлау. 4-апта: ешнәрсе соңғы сәтке қалмауы үшін қорлары бар оқу кестесін жасаңыз. Уақыт өте келе, тапсырмалар Q2-де шешілетіндіктен, азырақ тапсырма Q1-ге жетеді.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Сигнал: после чистки зубов. Действие: прочитать одну страницу (2 мин). Награда: отметить день в календаре серии. Постепенно увеличивайте продолжительность в течение недель.",
            answerKk: "Белгі: тіс тазалағаннан кейін. Тәртіп: бір бет оқу (2 мин). Марапат: серия күнтізбесін белгілеу. Апталар бойы ұзақтықты біртіндеп арттырыңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Сигнал (триггер), Действие (само поведение) и Награда (позитивное подкрепление).",
            answerKk: "Белгі (триггер), Тәртіп (мінез-құлықтың өзі) және Марапат (позитивті бекіту).",
          ...
          },
          {
            ...
            answerRu: "Сигнал: срабатывает будильник, сразу надеваете спортивную одежду, приготовленную с вечера. Действие: начните всего с 5 минут растяжки (правило 2 минут). Награда: наслаждайтесь любимым завтраком только после упражнений. Постепенно увеличивайте продолжительность в течение недель.",
            answerKk: "Белгі: оятқыш шырылдайды, кешке дайындалған спорттық киімді бірден киесіз. Тәртіп: тек 5 минуттық созылудан бастаңыз (2 минут ережесі). Марапат: жаттығудан кейін ғана сүйікті таңғы асыңызды тамашалаңыз. Апталар бойы ұзақтықты біртіндеп арттырыңыз.",
          ...
          },
          {
            ...
            answerRu: "Одновременное начало трёх привычек истощает силу воли и создаёт перегрузку. Перестройка: Месяц 1 — только ведение дневника (2 мин/день). Месяц 2 — добавьте чтение (2 мин/день), сохраняя дневник. Месяц 3 — добавьте упражнения (5 мин/день). Каждая привычка хорошо закрепляется перед добавлением следующей. Подход «наложения привычек» опирается на уже существующие рутины.",
            answerKk: "Үш дағдыны бірден бастау ерік-жігерді сарқып, шамадан тыс жүктеме тудырады. Қайта құру: 1-ай — тек күнделік жазу (2 мин/күн). 2-ай — күнделікті сақтай отырып оқуды қосу (2 мин/күн). 3-ай — жаттығуды қосу (5 мин/күн). Келесісін қосар алдында әр дағды жақсы бекітіледі. «Дағдыларды қабаттастыру» тәсілі бар рутиналарға негізделеді.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "20-минутные блоки фокуса с 5-минутными перерывами. Постепенно увеличивайте длину блока в течение недель по мере роста выносливости фокуса.",
            answerKk: "5 минуттық үзілісі бар 20 минуттық зейін блоктарын қолданыңыз. Зейін төзімділігі артқан сайын апталар бойы блоктың ұзақтығын біртіндеп арттырыңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "От 25 до 90 минут, в зависимости от человека, задачи и тренированности. Большинство учеников начинают с 25-30 минут.",
            answerKk: "Адамға, тапсырмаға және дайындыққа байланысты 25-тен 90 минутқа дейін. Көптеген оқушылар шамамен 25-30 минуттан бастайды.",
          ...
          },
          {
            ...
            answerRu: "Прогулка гораздо лучше — она даёт мозгу настоящий отдых через физическое движение и смену обстановки. Соцсети на самом деле нагружают те же зоны внимания, что усложняет повторную концентрацию. Хороший перерыв включает физическое движение, природу или просто закрытые глаза.",
            answerKk: "Серуендеу әлдеқайда жақсы — ол миға дене қозғалысы мен көрініс өзгеруі арқылы шынайы демалыс береді. Әлеуметтік медиа шын мәнінде сол зейін тізбектерін жүктеп, қайта фокустануды қиындатады. Жақсы үзіліс дене қозғалысын, табиғатты немесе жай көзді жұмуды қамтиды.",
          ...
          },
          {
            ...
            answerRu: "Пример: пиковые часы 9-11 утра и 15-17 часов. Средний фокус: 35 минут. Спад энергии: 13-14 часов после обеда. Оптимизировано: самые сложные предметы (математика, наука) — в пиковые 9-11 утра блоками по 35 минут. Послеобеденный спад — для лёгкого повторения или организации. Второй пик (15-17) — для творческой работы и эссе. Вечер — только для интервального повторения.",
            answerKk: "Мысал: ең жоғары сағаттар — таңғы 9-11 және түскі 15-17. Орташа зейін: 35 минут. Энергия құлдырауы: түскі астан кейін 13-14. Оңтайландырылған: ең қиын пәндер (математика, жаратылыстану) — 9-11 таңғы шыңда 35 минуттық блоктармен. Түскі астан кейінгі құлдырауды жеңіл қайталауға немесе реттеуге пайдаланыңыз. Екінші шың (15-17) — шығармашылық жұмыс пен эссеге. Кеш — тек аралықты қайталауға.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Дни 1-4: тема + план. Дни 5-9: введение + источники. Дни 10-14: основной текст. Дни 15-17: доработка. Дни 18-19: резерв. День 21: сдача.",
            answerKk: "1-4 күндер: тақырып + жоспар. 5-9 күндер: кіріспе + дереккөздер. 10-14 күндер: негізгі мәтін. 15-17 күндер: түзету. 18-19 күндер: қор. 21-күн: тапсыру."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Работа от дедлайна назад заставляет выделить конкретное время для каждого этапа и показывает, хватает ли у вас времени. Работа вперёд часто ведёт к прокрастинации, потому что дедлайн кажется далёким.",
            answerKk: "Мерзімнен кері жұмыс істеу әр кезеңге нақты уақыт бөлуге мәжбүрлеп, жеткілікті уақытыңыз бар-жоғын көрсетеді. Алға қарай жұмыс істеу көбіне кейінге қалдыруға әкеледі, өйткені мерзім алыс сияқты сезіледі.",
          ...
          },
          {
            ...
            answerRu: "Неделя 1: мозговой штурм и выбор темы всей группой. Неделя 2: разделите исследование — каждый берёт один раздел. Неделя 3: проведите эксперимент/соберите данные. Неделя 4: проанализируйте результаты, каждый пишет свой раздел. Неделя 5: объедините разделы, создайте презентацию/постер. Неделя 6: репетиция презентации, резерв на проблемы. Назначьте руководителя проекта для отслеживания этапов.",
            answerKk: "1-апта: топпен бірге ой қозғап, тақырып таңдау. 2-апта: зерттеуді бөліңіз — әркім бір бөлімді алады. 3-апта: тәжірибе жүргізу/деректер жинау. 4-апта: нәтижелерді талдау, әркім өз бөлімін жазады. 5-апта: бөлімдерді біріктіру, презентация/постер жасау. 6-апта: презентацияны жаттықтыру, мәселелерге қор. Кезеңдерді бақылау үшін жоба менеджерін тағайындаңыз.",
          ...
          },
          {
            ...
            answerRu: "Неделя 1: эссе по истории — исследование и черновик (приоритет, ближайший срок). По вечерам начинайте исследование по биологии. Неделя 2: завершите эссе по истории в пн-вт. Переключитесь на презентацию по биологии (ср-вс). Начните план портфолио по математике. Неделя 3: завершите презентацию по биологии к среде. Переключитесь на портфолио по математике (чт-вс). Неделя 4: завершите портфолио с резервом пн-ср. Ключ: определяйте, какой проект самый срочный на этой неделе, и уделяйте ему основное внимание, продолжая продвигать остальные.",
            answerKk: "1-апта: тарих эссесі — зерттеу мен қаралама (басымдық, ең жақын мерзім). Кешкі уақытта биология зерттеуін бастаңыз. 2-апта: тарих эссесін дс-сс аяқтаңыз. Биология презентациясына көшіңіз (ср-жс). Математика портфолиосының жоспарын бастаңыз. 3-апта: биология презентациясын сәрсенбіге дейін аяқтаңыз. Математика портфолиосына көшіңіз (бс-жс). 4-апта: портфолионы дс-ср қорымен аяқтаңыз. Негізгісі: әр аптада қай жоба ең шұғыл екенін анықтап, қалғандарын да ілгерілете отырып, соған негізгі назар аударыңыз.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Неделя 1: повторите все главы с активным воспроизведением и определите слабые места. Неделя 2: сосредоточьтесь на слабостях, пройдите пробные экзамены с таймером. День перед экзаменом: только лёгкое повторение. День экзамена: сначала прочитайте все вопросы, начните с самых сильных тем.",
            answerKk: "1-апта: барлық тарауларды белсенді еске түсірумен қайталап, әлсіз тұстарды анықтаңыз. 2-апта: әлсіз тұстарға назар аударып, уақыты бар пробный емтихандар тапсырыңыз. Емтиханның алдыңғы күні: тек жеңіл қайталау. Емтихан күні: алдымен барлық сұрақтарды оқыңыз, ең күшті тақырыптардан бастаңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Лёгкое повторение и ранний сон. Сон закрепляет память и сохраняет ясность ума. Зубрёжка вызывает истощение и тревогу, что вредит результатам больше, чем помогает дополнительная учёба.",
            answerKk: "Жеңіл қайталау және ерте ұйықтау. Ұйқы жадыны бекітіп, миды сергек ұстайды. Жаттау шаршау мен алаңдаушылық тудырады, бұл қосымша оқудың пайдасынан гөрі нәтижеге көбірек зиян тигізеді.",
          ...
          },
          {
            ...
            answerRu: "Временно пропустите его и ответьте на оставшиеся 9 вопросов, в которых увереннее. Вернитесь к сложному вопросу с оставшимся временем. Запишите любые частичные знания — частичный балл лучше, чем пустой ответ. Выделите примерно 4 минуты на каждый оставшийся вопрос и оставьте минимум 10 минут на сложный.",
            answerKk: "Оны уақытша өткізіп жіберіп, сенімдірек 9 сұраққа жауап беріңіз. Қалған уақытта қиын сұраққа қайта оралыңыз. Кез келген жартылай білімді жазып қойыңыз — жартылай балл бос қалдырудан жақсы. Қалған әр сұраққа шамамен 4 минут бөліп, қиынына кемінде 10 минут сақтап қойыңыз.",
          ...
          },
          {
            ...
            answerRu: "Неделя 1: создайте сводные листы и карточки для всех 5 предметов. Изучайте по 2 предмета в день с активным воспроизведением. Определите слабые места в каждом. Неделя 2: сосредоточьтесь на слабых местах. Чередуйте предметы, чтобы избежать усталости (утро: предмет А, день: предмет Б). Проходите пробные тесты. Неделя 3: составьте расписание по порядку экзаменов — сначала готовьтесь к понедельничному экзамену. За два дня до каждого экзамена: пробный тест с таймером. За день до: лёгкое повторение и ранний сон. Между экзаменами: краткое целевое повторение только для следующего. Ключ: не тратьте всё время на один предмет в ущерб остальным.",
            answerKk: "1-апта: барлық 5 пәнге қорытынды парақтар мен карточкалар жасаңыз. Күніне 2 пәнді белсенді еске түсірумен оқыңыз. Әрқайсысындағы әлсіз тұстарды анықтаңыз. 2-апта: әлсіз тұстарға назар аударыңыз. Шаршамау үшін пәндерді кезектестіріңіз (таңертең: А пәні, түсте: Б пәні). Пробный тесттер тапсырыңыз. 3-апта: емтихан ретіне қарай кесте құрыңыз — алдымен дүйсенбідегі емтиханға дайындалыңыз. Әр емтиханнан екі күн бұрын: уақыты бар пробный тест. Бір күн бұрын: жеңіл қайталау және ерте ұйықтау. Емтихандар арасында: тек келесісіне қысқа мақсатты қайталау. Негізгісі: барлық уақытты бір пәнге жұмсап, қалғандарын елемей қалдырмаңыз.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "SMART-цель: «Я подниму оценку по математике до A, набирая 90% и выше на всех оставшихся тестах до 15 декабря, занимаясь по 30 минут ежедневно.»",
            answerKk: "SMART мақсат: «15 желтоқсанға дейін барлық қалған тесттерде 90% және одан жоғары балл жинап, күн сайын 30 минут жаттығу арқылы математика бағамды A-ға көтеремін.»"
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "S — конкретная (Specific), M — измеримая (Measurable), A — достижимая (Achievable), R — актуальная (Relevant), T — ограниченная по времени (Time-bound).",
            answerKk: "S — нақты (Specific), M — өлшенетін (Measurable), A — қол жеткізілетін (Achievable), R — өзекті (Relevant), T — мерзімді (Time-bound).",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Стыковка привычек: «После того как сяду обедать, повторю 10 карточек перед едой.» Это привязывает новую привычку к уже существующему ежедневному триггеру.",
            answerKk: "Дағды тізбегі: «Түскі асқа отырғаннан кейін, жемес бұрын 10 карточканы қайталаймын.» Бұл жаңа дағдыны бар күнделікті триггерге байланыстырады."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "«После того как [текущая привычка], я буду [новая привычка]». Вы привязываете новое поведение к тому, что уже делаете автоматически.",
            answerKk: "«[Ағымдағы дағдыны] орындағаннан кейін, [жаңа дағдыны] жасаймын». Сіз жаңа мінез-құлықты автоматты түрде жасайтын нәрсеге бекітесіз.",
          ...
          },
          {
            ...
            answerRu: "(1) «Как сяду за парту на уроке, выпью полный стакан воды.» (2) «Как лягу в постель вечером, напишу три вещи, за которые благодарен.» (3) «Как закончу завтракать, повторю 10 слов на телефоне.»",
            answerKk: "(1) «Сабаққа партаға отырғанда, толық стакан су ішемін.» (2) «Кешке төсекке жатқанда, алғыс білдіретін үш нәрсені жазамын.» (3) «Таңғы асты аяқтағанда, телефонда 10 сөзді қайталаймын.»",
          ...
          },
          {
            ...
            answerRu: "Цепочка: после будильника → заправить кровать (1 мин, первая маленькая победа). После заправки кровати → выпить воды (гидратация). После воды → 5-минутная растяжка (пробудить тело). После растяжки → просмотр трёх главных приоритетов дня (фокус). После приоритетов → 10-минутная сфокусированная учёба (самая сложная задача). Порядок важен, потому что каждая привычка создаёт импульс — сначала физические (кровать, вода, растяжка), затем ментальные (приоритеты, учёба). Ранние победы создают мотивацию для более сложных задач.",
            answerKk: "Тізбек: оятқыштан кейін → төсекті жинау (1 мин, алғашқы жеңіс тудырады). Төсекті жинағаннан кейін → су ішу (сусындану). Судан кейін → 5 минуттық созылу (денені ояту). Созылудан кейін → бүгінгі 3 басты басымдықты қарау (фокус). Басымдықтарды қараудан кейін → 10 минуттық фокусталған оқу (ең қиын тапсырма). Реті маңызды, өйткені әр дағды серпін тудырады — алдымен физикалық (төсек, су, созылу), содан кейін ментальды (басымдықтар, оқу). Ерте жеңістер қиынырақ тапсырмаларға мотивация тудырады.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Каждый 30-60-минутный блок имеет назначенную цель. Самая сложная работа идёт первой, перерывы запланированы, а свободное время защищено — а не остаётся «что осталось».",
            answerKk: "Әр 30-60 минуттық блоктың белгіленген мақсаты бар. Ең қиын жұмыс бірінші орындалады, үзілістер жоспарланған, ал бос уақыт қорғалған — қалдық емес."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Список дел говорит вам, ЧТО делать, а расписание с блокировкой времени говорит, КОГДА делать каждую задачу. Блокировка времени даёт каждой задаче конкретный слот в календаре.",
            answerKk: "Тапсырмалар тізімі НЕ істеу керектігін айтады, ал уақыт блоктау кестесі әр тапсырманы ҚАШАН орындау керектігін көрсетеді. Уақытты блоктау әр тапсырмаға күнтізбеде нақты слот береді.",
          ...
          },
          {
            ...
            answerRu: "Вежливо скажите другу, что вы учитесь, и предложите перезвонить в запланированный блок свободного времени. Если это действительно срочно, решите вопрос кратко и продлите учебный блок на то же время, что было потеряно. Главное — защищать свои блоки, оставаясь гибким: переносите, а не пропускайте.",
            answerKk: "Досыңызға сыпайы түрде оқып жатқаныңызды айтып, жоспарланған бос уақыт блогында қоңырау шалуды ұсыныңыз. Егер бұл шынымен шұғыл болса, оны қысқаша шешіп, жоғалтқан уақытыңызша оқу блогын ұзартыңыз. Негізгісі — икемді бола отырып блоктарыңызды қорғау: өткізіп жібермей, ауыстырыңыз.",
          ...
          },
          {
            ...
            answerRu: "Пн/Ср/Пт (дни кружков): 8-15 школа, 15-17 кружок, 17-17:30 перекус/переход, 17:30-19:30 домашние задания (два блока по 50 мин), 19:30-20 ужин, 20-21 свободное время, 21-21:30 подготовка на завтра, 21:30-22 отдых, 22 сон. Вт/Чт: 8-15 школа, 15-15:30 спорт, 15:30-17:30 домашние задания, 17:30-18 ужин, 18-20 общение/хобби, 20-21 лёгкое повторение, 21:30 сон. Выходные: сон до 8, утренний спорт, 2-часовой блок учёбы, остальное время гибкое для общения и хобби.",
            answerKk: "Дс/Ср/Жм (үйірме күндері): 8-15 мектеп, 15-17 үйірме, 17-17:30 тағамдану/ауысу, 17:30-19:30 үй тапсырмасы (50 минуттық екі блок), 19:30-20 кешкі ас, 20-21 бос уақыт, 21-21:30 ертеңгі күнге дайындық, 21:30-22 демалу, 22 ұйқы. Сс/Бс: 8-15 мектеп, 15-15:30 жаттығу, 15:30-17:30 үй тапсырмасы, 17:30-18 кешкі ас, 18-20 қарым-қатынас/хобби, 20-21 жеңіл қайталау, 21:30 ұйқы. Демалыс күндері: 8-ге дейін ұйықтау, таңертеңгі жаттығу, 2 сағаттық оқу блогы, қалғаны қарым-қатынас пен хоббиге икемді.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Каждая заметка содержит одно понятие. Связи соединяют идеи из биологии и химии, показывая, что клеточное дыхание — это, по сути, серия химических окислительно-восстановительных реакций, производящих АТФ.",
            answerKk: "Әр жазба бір ұғымнан тұрады. Байланыстар биология мен химия идеяларын қосып, жасушалық тыныс алудың мәні АТФ өндіретін химиялық тотығу-тотықсыздану реакцияларының тізбегі екенін көрсетеді."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Одна идея на заметку, написанная своими словами, со связями к другим заметкам. Заметки должны быть атомарными — маленькими, самодостаточными и чётко связанными.",
            answerKk: "Бір жазбаға бір идея, өз сөзіңізбен жазылған, байланысты жазбаларға сілтемелермен. Жазбалар атомарлы болуы керек — кішкентай, дербес және анық байланысқан.",
          ...
          },
          {
            ...
            answerRu: "1) Идеи связаны, а не заперты в хронологическом порядке — можно находить связи между предметами. 2) Система становится «умнее» со временем, когда новые заметки связываются со старыми. 3) При написании эссе или подготовке к экзамену можно проследить цепочки связей, чтобы выстроить полноценные аргументы из существующих заметок.",
            answerKk: "1) Идеялар хронологиялық ретте қамалып қалмай, байланысқан — пәндер арасындағы байланыстарды табуға болады. 2) Жаңа жазбалар ескілерімен байланысқан сайын жүйе уақыт өте келе «ақылдырақ» болады. 3) Эссе жазғанда немесе емтиханға дайындалғанда, бар жазбаларыңыздан толық дәлелдер құру үшін байланыс тізбектерін қадағалауға болады.",
          ...
          },
          {
            ...
            answerRu: "Пример: Заметка А — «Фотосинтез» (Био), Заметка Б — «Углеродный цикл» (Гео), Заметка В — «Химические уравнения» (Химия), Заметка Г — «Промышленная революция» (История), Заметка Д — «Изменение климата» (Гео). Связи: А→В (фотосинтез — химическое уравнение), А→Б (фотосинтез движет углеродным циклом), Б→Д (нарушение углеродного цикла вызывает изменение климата), Г→Д (промышленная революция увеличила выбросы CO2), В→А (уравнивание уравнений применимо к фотосинтезу). Сеть показывает, как связаны наука и история.",
            answerKk: "Мысал: А-жазба — «Фотосинтез» (Био), Б-жазба — «Көміртек циклі» (Гео), В-жазба — «Химиялық теңдеулер» (Химия), Г-жазба — «Өнеркәсіптік революция» (Тарих), Д-жазба — «Климат өзгерісі» (Гео). Байланыстар: А→В (фотосинтез — химиялық теңдеу), А→Б (фотосинтез көміртек циклін қозғайды), Б→Д (көміртек циклінің бұзылуы климат өзгерісін тудырады), Г→Д (өнеркәсіптік революция CO2 шығарындыларын арттырды), В→А (теңдеулерді теңестіру фотосинтезге де қолданылады). Тор ғылым мен тарихтың қалай байланысатынын көрсетеді.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Организуйте цифровое рабочее пространство по разделам: Проекты, Области, Ресурсы и Архивы. Фиксируйте информацию сразу и распределяйте её по проекту или области, которые она поддерживает.",
            answerKk: "Цифрлық жұмыс кеңістігін Жобалар, Салалар, Ресурстар және Мұрағаттарға бөліп ұйымдастырыңыз. Ақпаратты бірден түсіріп, ол қолдайтын жоба немесе сала бойынша сақтаңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Проекты (активные задачи с дедлайнами), Области (постоянные обязанности), Ресурсы (интересующие темы), Архивы (завершённые или неактивные элементы).",
            answerKk: "Жобалар (мерзімі бар белсенді тапсырмалар), Салалар (тұрақты міндеттер), Ресурстар (қызықтыратын тақырыптар), Мұрағаттар (аяқталған немесе белсенді емес элементтер).",
          ...
          },
          {
            ...
            answerRu: "Она попадает в Ресурсы (техники учёбы), а не в папку проекта по биологии — потому что статья полезна широко, не только для этого одного проекта. Однако можно добавить на неё ссылку и в папку проекта по биологии. Ресурсы предназначены для долгосрочных справочных материалов, которые могут понадобиться в нескольких проектах.",
            answerKk: "Ол Ресурстарға (оқу техникалары) кетеді, биология Жоба қалтасына емес — өйткені мақала осы бір жобадан тыс кеңінен пайдалы. Дегенмен, биология жоба қалтасына да сілтеме немесе анықтама қосуға болады. Ресурстар бірнеше жобада қажет болуы мүмкін ұзақ мерзімді анықтамалық материалдарға арналған.",
          ...
          },
          {
            ...
            answerRu: "Инструмент: Notion (бесплатно для студентов). Захват: быстрый входящий ящик для всех идей/заметок в течение дня. Обработка: каждый вечер перемещайте элементы из входящих в нужную папку PARA. Проекты: каждое школьное задание, заявка в вуз, внеклассное мероприятие. Области: каждый предмет, здоровье, семейные обязанности. Ресурсы: методы учёбы, исследование карьеры, интересные темы. Архивы: завершённые проекты/семестры. Еженедельный обзор (воскресенье, 30 мин): проверьте прогресс всех активных проектов, просмотрите ближайшие дедлайны, переместите завершённые элементы в архив, определите топ-3 приоритета на неделю.",
            answerKk: "Құрал: Notion (студенттерге тегін). Түсіру: күні бойы барлық идеялар/жазбалар үшін жылдам кіріс жәшігі. Өңдеу: әр кеште кіріс элементтерін дұрыс PARA қалтасына жылжытыңыз. Жобалар: әр мектеп тапсырмасы, университетке өтініш, қосымша шара. Салалар: әр пән, денсаулық, отбасылық міндеттер. Ресурстар: оқу әдістері, мансап зерттеуі, қызықты тақырыптар. Мұрағаттар: аяқталған жобалар/семестрлер. Апталық шолу (жексенбі, 30 мин): барлық белсенді жобалардың прогресін тексеріңіз, алдағы мерзімдерді қараңыз, аяқталған элементтерді мұрағатқа жылжытыңыз, аптаның топ-3 басымдығын анықтаңыз.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Пик 9-11 утра: самые сложные предметы. Спад 13-14: лёгкое повторение и организация. Восстановление 15-17: творческие и умеренные задачи.",
            answerKk: "9-11 таңғы шың: ең қиын пәндер. 13-14 құлдырау: жеңіл қайталау және реттеу. 15-17 қалпына келу: шығармашылық және орташа тапсырмалар."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Потому что час свободного времени ничего не значит, если вы слишком устали, чтобы сосредоточиться. 30-минутная сессия на пике энергии может дать больше, чем 2 часа занятий в истощённом состоянии.",
            answerKk: "Себебі зейін қоя алмайтындай шаршасаңыз, бір сағат бос уақыттың мәні жоқ. Энергия шыңында өткізілген 30 минуттық сеанс шаршаған кездегі 2 сағаттық оқудан көбірек нәтиже бере алады.",
          ...
          },
          {
            ...
            answerRu: "Пример: утренний пик (8-10, энергия 8-9), стабильная середина дня (10-12, энергия 7), послеобеденный спад (13-14, энергия 4-5), дневное восстановление (15-17, энергия 6-7), вечерний спад (19-21, энергия 5-4). Используйте эту карту для распределения задач по сложности.",
            answerKk: "Мысал: таңғы шың (8-10, энергия 8-9), күннің ортасында тұрақты (10-12, энергия 7), түскі астан кейінгі құлдырау (13-14, энергия 4-5), түстен кейінгі қалпына келу (15-17, энергия 6-7), кешкі құлдырау (19-21, энергия 5-4). Бұл картаны тапсырмаларды қиындығына қарай бөлу үшін қолданыңыз.",
          ...
          },
          {
            ...
            answerRu: "Сон: 8-9 часов, постоянное время отхода ко сну/подъёма (регулирует циркадный ритм, закрепление памяти происходит во сне). Питание: завтрак с белком и сложными углеводами (стабильный сахар в крови = стабильный фокус), избегайте скачков сахара перед учёбой. Спорт: 30 минут ежедневно (повышает BDNF, улучшающий обучение, настроение и фокус на 2-3 часа после). Расписание учёбы: самые сложные задачи на пике энергии (обычно утром), творческие задачи при умеренной энергии, повторение при низкой энергии. Гидратация: 2 л воды в день (даже лёгкое обезвоживание снижает когнитивные показатели на 25%).",
            answerKk: "Ұйқы: 8-9 сағат, тұрақты ұйықтау/ояну уақыты (циркадтық ырғақты реттейді, жады бекітілуі ұйқы кезінде болады). Тамақтану: ақуыз бен күрделі көмірсулары бар таңғы ас (тұрақты қан қанты = тұрақты зейін), оқу алдында қант секірулерінен аулақ болыңыз. Жаттығу: күн сайын 30 минут (оқуды жақсартатын BDNF-ті арттырады, кейінгі 2-3 сағатқа көңіл-күй мен зейінді жақсартады). Оқу кестесі: ең қиын тапсырмалар энергия шыңында (көбіне таңертең), орташа энергия кезінде шығармашылық тапсырмалар, төмен энергия кезінде қайталау. Сусындану: күніне 2 л су (тіпті аздап сусыздану когнитивтік өнімділікті 25%-ға төмендетеді).",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Группируйте почту в 3 сессии в день. Группируйте уроки по типу: всё чтение вместе, вся математика вместе, всё письмо вместе. Это устраняет постоянные переключения контекста.",
            answerKk: "Поштаны күніне 3 сеансқа топтаңыз. Үй тапсырмасын түрі бойынша топтаңыз: барлық оқу бірге, барлық математика бірге, барлық жазу бірге. Бұл тұрақты контекст ауыстыруларын жояды."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Мозгу нужно 15-25 минут, чтобы полностью перефокусироваться после переключения задач. Эта «стоимость переключения» означает, что вы теряете значительное время и умственную энергию при каждой смене, даже если кажется, что вы продуктивны.",
            answerKk: "Тапсырманы ауыстырғаннан кейін миыңызға толық қайта зейін қою үшін 15-25 минут қажет. Бұл «ауыстыру құны» өнімді сезінсеңіз де, әр өзгеріс кезінде елеулі уақыт пен ой-энергиясын жоғалтатыныңызды білдіреді.",
          ...
          },
          {
            ...
            answerRu: "Пакет 1 (Аналитика/Математика): задачи по математике + листы по науке (оба требуют логического/количественного мышления). Пакет 2 (Чтение): главы истории (режим устойчивого чтения). Пакет 3 (Творчество/Письмо): план эссе по английскому (режим письма). Порядок: начните с Пакета 1 (самый сложный, требует больше всего энергии), затем Пакет 2, затем Пакет 3. Делайте 10-минутные перерывы между пакетами.",
            answerKk: "1-топтама (Аналитикалық/Математика): математика есептері + жаратылыстану жұмыс парақтары (екеуі де логикалық/сандық ойлауды қажет етеді). 2-топтама (Оқу): тарих тараулары (тұрақты оқу режимі). 3-топтама (Шығармашылық/Жазу): ағылшын эссесінің жоспары (жазу режимі). Реті: 1-топтамадан бастаңыз (ең қиын, көп энергия қажет), содан кейін 2-топтама, содан кейін 3-топтама. Топтамалар арасында 10 минуттық үзіліс жасаңыз.",
          ...
          },
          {
            ...
            answerRu: "Если ученик переключает задачи 8 раз за 4 часа (в среднем каждые 30 мин), а каждое переключение стоит 15 минут перефокусировки, это до 2 часов потерянной продуктивности — половина вечера! Перестройка: 3 пакета по 60-70 минут с 10-минутными перерывами между ними. Телефон убран. Группировка по типу мышления. Заметки организуются один раз в конце. Та же работа выполняется за 3 часа с лучшим качеством, освобождая час на отдых.",
            answerKk: "Егер оқушы 4 сағатта тапсырмаларды 8 рет ауыстырса (орта есеппен әр 30 минут сайын) және әр ауыстыру 15 минуттық қайта зейін қоюға тұрса, бұл жоғалтылған өнімділіктің 2 сағатына дейін — кештің жартысы! Қайта құру: арасында 10 минуттық үзілісі бар 60-70 минуттан 3 топтама. Телефон жабулы. Ойлау түрі бойынша топтау. Жазбалар соңында бір рет реттеледі. Сол жұмыс жақсырақ сапамен 3 сағатта орындалып, демалуға бір сағат бос қалады.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Потратьте 60% времени учёбы на 3 главы, которые составляют 75% вопросов. Оставшиеся 40% используйте на общий обзор остальных глав.",
            answerKk: "Оқу уақытының 60%-ын сұрақтардың 75%-ын құрайтын 3 тарауға жұмсаңыз. Қалған 40%-ды басқа тарауларды жалпы шолуға пайдаланыңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Небольшая часть ваших усилий даёт большую часть результатов. Пример: в математике освоение 5 ключевых типов задач может подготовить вас к 80% вопросов теста, а остальные 20 типов покрывают лишь 20% теста.",
            answerKk: "Күш-жігеріңіздің аз бөлігі нәтижелеріңіздің көп бөлігін береді. Мысал: математикада 5 негізгі есеп түрін меңгеру тест сұрақтарының 80%-ына дайындауы мүмкін, ал қалған 20 есеп түрі тесттің тек 20%-ын қамтиды.",
          ...
          },
          {
            ...
            answerRu: "Высокоэффективные 20%: тестирование активным воспроизведением, решение практических задач и обучение других концепциям. Это требует глубокой вовлечённости. Вместо этого большинство учеников тратят 80% времени на малоэффективные действия: перечитывание конспектов, выделение и переписывание. Решение: поменяйте соотношение местами — тратьте больше времени на активные методы.",
            answerKk: "Жоғары тиімді 20%: белсенді еске түсірумен тестілеу, жаттығу есептерін шешу және басқаларға ұғымдарды үйрету. Бұлар терең араласуды талап етеді. Оның орнына көптеген оқушылар уақыттың 80%-ын аз тиімді әрекеттерге жұмсайды: конспектілерді қайта оқу, бөлектеу және қайта көшіру. Шешім: қатынасты керісінше өзгертіңіз — көп уақытты белсенді әдістерге жұмсаңыз.",
          ...
          },
          {
            ...
            answerRu: "Пример для истории: проанализируйте 3 прошлых экзамена — обнаружите, что вопросы эссе сосредоточены на причинах/следствиях (а не датах), и 4 темы (революция, экономика, социальные изменения, внешняя политика) повторяются регулярно. План: сосредоточьте 70% времени учёбы на понимании причин/следствий событий в рамках этих 4 тем с активным воспроизведением. Сократите время на заучивание малозначимых дат (низкая отдача). Исключите: переписывание отрывков учебника, чрезмерное цветовое кодирование заметок, чтение дополнительных глав, которые никогда не встречаются на тестах.",
            answerKk: "Тарих үшін мысал: 3 өткен емтиханды талдаңыз — эссе сұрақтары күндерге емес, себеп-салдарларға бағытталғанын және 4 тақырып (революция, экономика, әлеуметтік өзгеріс, сыртқы саясат) қайта-қайта кездесетінін табасыз. Жоспар: оқу уақытының 70%-ын осы 4 тақырып шеңберіндегі оқиғалардың себеп-салдарын белсенді еске түсірумен түсінуге бағыттаңыз. Күмәнді күндерді жаттауға кететін уақытты азайтыңыз (аз тиімді). Жойыңыз: оқулық үзінділерін қайта көшіру, жазбаларды шектен тыс түспен кодтау, тестте ешқашан кездеспейтін қосымша тарауларды оқу.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Найдите партнёра по подотчётности, делитесь конкретными еженедельными целями, проверяйтесь каждое воскресенье и устанавливайте реальные последствия за невыполнение.",
            answerKk: "Есеп беру серіктесін тауып, нақты апталық мақсаттармен бөлісіңіз, әр жексенбіде тексеріп отырыңыз және орындалмаған мақсаттар үшін нақты салдар белгілеңіз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Это создаёт социальное давление — вы не хотите подвести человека или показаться ненадёжным. Также цель ощущается более реальной и конкретной, и у вас есть с кем отпраздновать успех.",
            answerKk: "Бұл әлеуметтік қысым тудырады — сіз басқа адамды алдап қалғыңыз немесе сенімсіз көрінгіңіз келмейді. Сондай-ақ мақсат нақтырақ әрі шынайырақ сезіледі, және сәтті болғанда бірге тойлайтын адамыңыз болады.",
          ...
          },
          {
            ...
            answerRu: "Каждый участник ставит 3 конкретные еженедельные цели и публикует их в групповом чате в понедельник утром. Ежедневная 2-минутная текстовая проверка: что вы сделали сегодня? Среда — промежуточный звонок-обзор (15 мин). Воскресенье — встреча по подотчётности (30 мин): поделитесь прогрессом, определите препятствия, поставьте цели на следующую неделю. Участники, не выполнившие цели, должны объяснить группе одну тему, с которой у них были трудности (позитивное последствие).",
            answerKk: "Әр қатысушы 3 нақты апталық мақсат қойып, дүйсенбі таңертең топ чатына жариялайды. Күнделікті 2 минуттық мәтіндік тексеру: бүгін не орындадыңыз? Сәрсенбіде апта ортасындағы шолу қоңырауы (15 мин). Жексенбіде есеп беру кездесуі (30 мин): прогресспен бөлісіңіз, кедергілерді анықтаңыз, келесі апта мақсаттарын қойыңыз. Мақсатын орындамаған қатысушылар топқа қиналған бір тақырыпты түсіндіруі керек (оң салдар).",
          ...
          },
          {
            ...
            answerRu: "1) Публичное обязательство через соцсети или блог — публикуйте еженедельные цели и обновления прогресса. Аудитория создаёт подотчётность даже без прямого партнёра. 2) Дневник самоподотчётности: каждый вечер оценивайте выполнение сегодняшней цели (1-10) и пишите почему. Отслеживайте серии — видимая запись создаёт самоподотчётность. 3) Используйте приложение для подотчётности или онлайн-сообщество (например, StudyStream или Discord-серверы для учёбы), где незнакомцы держат друг друга ответственными через совместные сессии. Ключ: любая внешняя видимость ваших обязательств повышает выполнение.",
            answerKk: "1) Әлеуметтік медиа немесе блог арқылы қоғамдық міндеттеме — апталық мақсаттар мен прогресс жаңартуларын жариялаңыз. Аудитория тікелей серіктес болмаса да есеп беруді тудырады. 2) Өзін-өзі есеп беру күнделігі: әр кеші бүгінгі мақсаттың орындалуын (1-10) бағалап, себебін жазыңыз. Серияларды бақылаңыз — көрінетін жазба өзіндік есеп беруді тудырады. 3) Есеп беру қосымшасын немесе онлайн оқу қауымдастығын (StudyStream немесе Discord оқу серверлері сияқты) қолданыңыз, онда бейтаныс адамдар бірлескен жұмыс сеанстары арқылы бір-бірін жауапкершілікте ұстайды. Кілті: міндеттемелеріңіздің кез келген сыртқы көрінуі орындалуды арттырады.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Перенесите все дедлайны в мастер-календарь, определите напряжённые недели, начинайте раньше при пересекающихся дедлайнах, разбейте на 4-недельные блоки, проводите еженедельный обзор.",
            answerKk: "Барлық мерзімдерді негізгі күнтізбеге ауыстырыңыз, қысым апталарын анықтаңыз, қабаттасатын мерзімдер үшін ерте бастаңыз, 4 апталық блоктарға бөліңіз, апта сайын шолу жасаңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Соберите все программы курсов и перенесите каждый крупный дедлайн, экзамен и срок сдачи проекта в единый мастер-календарь, чтобы видеть весь семестр сразу.",
            answerKk: "Барлық пән силлабустарын жинап, әрбір негізгі мерзімді, емтиханды және жоба тапсыру күнін бір негізгі күнтізбеге ауыстырыңыз, осылайша бүкіл семестрді бірден көре аласыз.",
          ...
          },
          {
            ...
            answerRu: "Начните готовиться на неделе 7-8: приступите к черновикам проектов и учёбе к экзаменам за 2-3 недели раньше. К неделе 9 проекты должны быть готовы на 80%, а повторение к экзаменам — на этапе активного воспроизведения. Неделя 10: только финальные правки и лёгкое повторение. Напряжённая неделя должна быть для завершения, а не для начала.",
            answerKk: "7-8-аптада дайындалуды бастаңыз: жоба жобаларын және емтиханға дайындықты 2-3 апта бұрын бастаңыз. 9-аптаға дейін жобалар 80% дайын болуы керек, ал емтиханды қайталау белсенді еске түсіру кезеңінде болуы керек. 10-апта: тек соңғы түзетулер мен жеңіл қайталау. Қысым апта аяқтауға арналуы керек, бастауға емес.",
          ...
          },
          {
            ...
            answerRu: "Мастер-календарь: все дедлайны курсов + сроки подачи в университет + рабочий график. Недельный шаблон: 30 ч школа, 8 ч работа, 3 ч кружки, 14 ч учёба (2 ч/день), 56 ч сон, 8 ч еда, остаётся ~49 ч на дорогу, общение, личное время. Месячные блоки: Месяцы 1-2 — фундамент по курсам + начало эссе для университета. Месяц 3 — подготовка к промежуточным экзаменам + завершение заявок в университет. Месяц 4 — семестровые проекты + подготовка к финалам. Воскресный еженедельный обзор (30 мин): проверьте все дедлайны на ближайшие 2 недели, скорректируйте дневное расписание. Ключ: заявки в университет рассматриваются как 7-й предмет со своим недельным блоком времени.",
            answerKk: "Негізгі күнтізбе: барлық курс мерзімдері + университетке өтініш мерзімдері + жұмыс кестесі. Апталық үлгі: 30 сағ мектеп, 8 сағ жұмыс, 3 сағ үйірме, 14 сағ оқу (күніне 2 сағ), 56 сағ ұйқы, 8 сағ тамақ, жол, қарым-қатынас, жеке уақытқа ~49 сағ қалады. Айлық блоктар: 1-2 ай — курс негізі + университет эссесін бастау. 3-ай — аралық емтихандарға дайындық + университет өтініштерін аяқтау. 4-ай — семестрлік жобалар + финалдарға дайындық. Жексенбілік апталық шолу (30 мин): келесі 2 аптаның барлық мерзімдерін тексеріп, күнделікті кестені түзетіңіз. Кілті: университет өтініштері өз апталық уақыт блогы бар 7-пән ретінде қарастырылады.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Используйте цифровой инструмент с зонами Входящие/Заметки/Проекты/Архив. Захватывайте ежедневно, обрабатывайте еженедельно, проводите ежемесячный обзор для поиска связей. Система растёт вместе с вами до университета.",
            answerKk: "Кіріс/Жазбалар/Жобалар/Мұрағат аймақтары бар цифрлық құрал қолданыңыз. Күн сайын түсіріңіз, апта сайын өңдеңіз, байланыстар үшін ай сайын шолыңыз. Жүйе сізбен бірге университетке дейін өседі."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Обычное конспектирование однонаправленно (записал и забыл), тогда как PKM — живая система, где заметки связаны, пересматриваются и активно используются для создания нового знания. PKM становится ценнее со временем.",
            answerKk: "Кәдімгі жазба жасау бір бағытты (жазып, ұмыту), ал PKM — жазбалар байланысатын, қайта қаралатын және жаңа білім жасау үшін белсенді пайдаланылатын тірі жүйе. PKM уақыт өте келе құндырақ болады.",
          ...
          },
          {
            ...
            answerRu: "Зафиксируйте ключевые идеи своими словами (не копируя). Создайте отдельные заметки для разных понятий (например, «Этические дилеммы ИИ», «Основы машинного обучения», «Карьерные пути в ИИ»). Свяжите каждую заметку с релевантными существующими заметками в папках информатики, философии и карьеры. Добавьте теги #AI #ethics #career. Одна эта статья теперь обогащает три области вашей базы знаний.",
            answerKk: "Негізгі идеяларды өз сөзіңізбен түсіріңіз (көшіріп алмай). Әртүрлі ұғымдар үшін жеке жазбалар жасаңыз (мысалы, «ЖИ этикалық дилеммалары», «Машиналық оқыту негіздері», «ЖИ мансап жолдары»). Әр жазбаны информатика, философия және мансап қалталарындағы қатысты бар жазбаларға байланыстырыңыз. #AI #ethics #career тегтерін қосыңыз. Осы бір мақала енді білім базаңыздың үш саласын байытады.",
          ...
          },
          {
            ...
            answerRu: "Захват: Уроки — быстрые заметки в телефоне во время/после урока. Книги — выделения + заметки на полях, переносить еженедельно. Подкасты — голосовые заметки ключевых идей. Беседы — записывайте ключевые моменты сразу после. Личные инсайты — отдельная заметка «идеи», всегда доступная. Обработка (ежедневно 10 мин): переносите все захваты во входящие, переписывайте своими словами, определяйте главную идею. Связывание (еженедельно 30 мин): связывайте новые заметки со старыми, ищите межпредметные закономерности, обновляйте заметки проектов. Извлечение: начиная любой проект, сначала ищите в системе PKM — прошлые инсайты становятся строительными блоками для новой работы. Ежемесячный обзор: какие темы появляются? Какие пробелы существуют?",
            answerKk: "Түсіру: Сабақтар — сабақ кезінде/кейін телефонда жылдам жазбалар. Кітаптар — белгілеулер + жиек жазбалары, апта сайын көшіру. Подкасттар — негізгі идеялардың дауыстық жазбалары. Әңгімелер — негізгі ойларды бірден кейін жазып алу. Жеке түсініктер — әрдайым қолжетімді бөлек «идеялар» жазбасы. Өңдеу (күн сайын 10 мин): барлық түсірулерді кіріске жылжытыңыз, өз сөзіңізбен қайта жазыңыз, негізгі идеяны анықтаңыз. Байланыстыру (апта сайын 30 мин): жаңа жазбаларды бар жазбалармен байланыстырыңыз, пәнаралық заңдылықтарды іздеңіз, жоба жазбаларын жаңартыңыз. Алу: кез келген жобаны бастағанда, алдымен PKM жүйесінен іздеңіз — өткен түсініктер жаңа жұмысқа құрылыс блоктары болады. Айлық шолу: қандай тақырыптар пайда болып жатыр? Қандай олқылықтар бар?",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Выполняйте 2-минутные задачи сразу (заказать книгу, положить книгу в рюкзак). Остальное планируйте с конкретными следующими действиями. Разбейте «поиск стипендий» на проект с шагами. Входящие теперь пусты.",
            answerKk: "2 минуттық тапсырмаларды бірден орындаңыз (кітапты тапсырыс беру, кітапты сөмкеге салу). Қалғанын нақты келесі әрекеттермен жоспарлаңыз. «Стипендияларды зерттеуді» қадамдары бар жобаға бөліңіз. Кіріс енді бос."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Если задача занимает меньше 2 минут, выполните её сразу, вместо того чтобы добавлять в список. Это эффективно, потому что мелкие задачи накапливаются и создают ментальный беспорядок. Мгновенное решение держит систему чистой, а разум свободным.",
            answerKk: "Егер тапсырма 2 минуттан аз уақыт алса, оны тізімге қоспай, бірден орындаңыз. Бұл тиімді, себебі ұсақ тапсырмалар жиналып, ойлау бей-берекетсіздігін тудырады. Оларды дереу шешу жүйені таза, ойды бос ұстайды.",
          ...
          },
          {
            ...
            answerRu: "Проект — это любой результат, требующий более одного шага (например, «Завершить заявку в MIT»). Следующее действие — единственный конкретный физический шаг, который можно сделать прямо сейчас (например, «Открыть портал заявки MIT и заполнить личные данные»). GTD требует, чтобы у каждого проекта всегда было чёткое следующее действие — иначе он застревает.",
            answerKk: "Жоба — бірден көп қадамды қажет ететін кез келген нәтиже (мысалы, «MIT-ке университет өтінішін аяқтау»). Келесі әрекет — қазір орындай алатын жалғыз, нақты, физикалық қадам (мысалы, «MIT өтініш порталын ашып, жеке ақпарат бөлімін толтыру»). GTD әр жобаның әрқашан нақты келесі әрекеті болуын талап етеді — әйтпесе ол тоқтап қалады.",
          ...
          },
          {
            ...
            answerRu: "Инструменты: Todoist (задачи) + Google Calendar (привязанные ко времени) + Notion (справка/проекты). Процесс: каждая мысль/задача сразу попадает во входящие Todoist. Ежедневная обработка (10 мин): уточните каждый пункт, примените правило 2 минут, распределите по проектам или календарю. Список проектов: каждый курс, каждая заявка в вуз, каждая личная цель — все с чёткими следующими действиями. Контексты: @школа, @дом, @компьютер, @телефон (выполняйте задачи в зависимости от места). Еженедельный обзор (воскресенье, 45 мин): обнулите входящие, проверьте все проекты на застрявшие пункты, проверьте календарь на ближайшие дедлайны, определите топ-3 приоритета недели, отпразднуйте успехи прошлой недели.",
            answerKk: "Құралдар: Todoist (тапсырмалар) + Google Calendar (уақытқа байланысты) + Notion (анықтама/жобалар). Жұмыс процесі: әр ой/тапсырма бірден Todoist кірісіне түседі. Күнделікті өңдеу (10 мин): әр элементті нақтылаңыз, 2 минут ережесін қолданыңыз, жобаларға немесе күнтізбеге бөліңіз. Жобалар тізімі: әр курс, әр университет өтініші, әр жеке мақсат — барлығы нақты келесі әрекеттермен. Контексттер: @мектеп, @үй, @компьютер, @телефон (орналасқан жеріңізге қарай тапсырмаларды орындаңыз). Апталық шолу (жексенбі, 45 мин): кірісті нөлге дейін тазалаңыз, барлық жобаларды тоқтап қалған элементтерге тексеріңіз, алдағы мерзімдер үшін күнтізбені тексеріңіз, аптаның топ-3 басымдығын анықтаңыз, өткен апта жеңістерін тойлаңыз.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Годовое видение каскадом переходит в квартальные цели, месячные вехи и недельные действия. Каждый квартал фокусируется на 2-3 ключевых областях с измеримыми целями.",
            answerKk: "Жылдық көзқарас тоқсандық мақсаттарға, айлық кезеңдерге және апталық әрекеттерге каскадпен түседі. Әр тоқсан өлшенетін мақсаттары бар 2-3 негізгі салаға назар аударады."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Квартальное планирование разбивает подавляющие годовые цели на управляемые 3-месячные спринты. Это позволяет фокусироваться на нескольких приоритетах за раз, регулярно измерять прогресс и корректировать курс, не теряя весь год.",
            answerKk: "Тоқсандық жоспарлау шамадан тыс жылдық мақсаттарды басқарылатын 3 айлық спринттерге бөледі. Бұл бір уақытта бірнеше басымдыққа назар аударуға, прогресті тұрақты өлшеуге және бүкіл жылды жоғалтпай бағытты түзетуге мүмкіндік береді.",
          ...
          },
          {
            ...
            answerRu: "Перенесите незавершённую работу над заявками на первые 2 недели Q2 как главный приоритет. Скорректируйте цели Q2: возможно, отложите одну цель Q2 на Q3. Установите жёсткий дедлайн для заявок (например, 15 января) и работайте от него назад. Проанализируйте, почему Q1 не удался — плохая оценка времени, прокрастинация или непредвиденные события? Устраните первопричину, чтобы не повторить паттерн.",
            answerKk: "Аяқталмаған өтініш жұмысын Q2-нің алғашқы 2 аптасына басты басымдық ретінде жылжытыңыз. Q2 мақсаттарын реттеңіз: мүмкін, бір Q2 мақсатын Q3-ке кейінге қалдырыңыз. Өтініштер үшін қатаң мерзім белгілеңіз (мысалы, 15 қаңтар) және одан кері жұмыс істеңіз. Q1 неге сәтсіз болғанын талдаңыз — нашар уақытты бағалау ма, кейінге қалдыру ма, әлде күтпеген оқиғалар ма? Үлгінің қайталануын болдырмау үшін түпкі себепті шешіңіз.",
          ...
          },
          {
            ...
            answerRu: "Учёба: Q1 — GPA 3.8+, Q2 — средний балл A на финалах, Q3 — окончить с отличием, Q4 — чтение для подготовки к университету. Здоровье: Q1 — привычка заниматься спортом 3 раза в неделю, Q2 — добавить отслеживание питания, Q3 — пробежать 5 км, Q4 — поддерживать режим. Отношения: Q1 — еженедельный семейный ужин, ежемесячная встреча с друзьями, Q2-Q4 — поддерживать и углублять. Навыки: Q1 — начать изучать программирование, Q2 — создать первый проект, Q3 — завершить онлайн-курс, Q4 — внести вклад в open source. Финансы: Q1 — отслеживать все расходы, Q2 — откладывать 20% любого дохода, Q3 — подать заявки на 5 стипендий, Q4 — создать резервный фонд на 3 месяца. Обзор: ежемесячная 30-минутная проверка всех 5 сфер. Квартальный 2-часовой глубокий обзор: оцените каждую сферу 1-10, скорректируйте цели следующего квартала.",
            answerKk: "Оқу: Q1 — GPA 3.8+, Q2 — финалдарда орташа A, Q3 — үздік бітіру, Q4 — университетке дайындық оқуы. Денсаулық: Q1 — аптасына 3 рет жаттығу дағдысы, Q2 — тамақтануды бақылауды қосу, Q3 — 5 км жүгіру, Q4 — режимді сақтау. Қарым-қатынас: Q1 — апталық отбасылық кешкі ас, айлық достармен кездесу, Q2-Q4 — сақтау және тереңдету. Дағдылар: Q1 — бағдарламалауды үйренуді бастау, Q2 — алғашқы жобаны жасау, Q3 — онлайн курсты аяқтау, Q4 — ашық кодқа үлес қосу. Қаржы: Q1 — барлық шығынды бақылау, Q2 — кез келген табыстың 20%-ын жинау, Q3 — 5 стипендияға өтініш беру, Q4 — 3 айлық төтенше қор құру. Шолу: 5 саланың барлығын айлық 30 минуттық тексеру. Тоқсандық 2 сағаттық терең шолу: әр саланы 1-10 бойынша бағалап, келесі тоқсан мақсаттарын түзетіңіз.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Создайте три 5-летних плана, прототипируйте каждый через реальный опыт (наблюдение за профессионалом, интервью, эксперименты), оцените по вовлечённости и энергии, затем выбирайте на основе данных, а не догадок.",
            answerKk: "Үш 5 жылдық жоспар жасаңыз, әрқайсысын нақты өмірлік тәжірибелер арқылы прототиптеңіз (мамандарды бақылау, сұхбат, тәжірибелер), қатысу мен энергия бойынша бағалаңыз, содан кейін болжаудың орнына деректерге сүйеніп таңдаңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "План Одиссеи — это подробный 5-летний план жизни. Вы создаёте три разные версии, чтобы исследовать несколько возможностей, снизить давление поиска одного «идеального» пути и обнаружить варианты, которые никогда бы не рассмотрели с одним планом.",
            answerKk: "Одиссей жоспары — егжей-тегжейлі 5 жылдық өмір жоспары. Сіз бірнеше мүмкіндікті зерттеу, бір «тамаша» жол табу қысымын азайту және бір жоспармен ешқашан қарастырмайтын нұсқаларды табу үшін үш түрлі нұсқа жасайсыз.",
          ...
          },
          {
            ...
            answerRu: "1) Пройдите бесплатный онлайн-вводный курс по Data Science (10 часов). 2) Поработайте с реальным датасетом на Kaggle и создайте простой анализ. 3) Возьмите интервью у 2 дата-сайентистов об их повседневной работе (по 15 мин). 4) Оцените опыт: понравилось ли решение задач? Забывали ли вы о времени? Хотели бы делать это ежедневно? Этот прототип стоит дней, а не лет, и даёт реальные данные о вашем интересе.",
            answerKk: "1) Data Science бойынша тегін онлайн кіріспе курсын өтіңіз (10 сағат). 2) Kaggle-де нақты деректер жинағымен жұмыс істеп, қарапайым талдау жасаңыз. 3) 2 дата-сайентиспен олардың күнделікті жұмысы туралы сұхбат алыңыз (әрқайсысы 15 мин). 4) Тәжірибеңізді бағалаңыз: есеп шешу ұнады ма? Уақыттан адасып қалдыңыз ба? Мұны күнделікті жасағыңыз келе ме? Бұл прототип жылдарды емес, күндерді алады және қызығушылығыңыз туралы нақты дерек береді.",
          ...
          },
          {
            ...
            answerRu: "Пример: План A (Традиционный): местный университет → степень по информатике → стажировка в IT-компании → штатный инженер-программист → своя квартира в городе. План B (Авантюрный): учёба за рубежом в Европе → двойная специализация Бизнес + Дизайн → фриланс во время путешествий → открытие дизайн-агентства → жизнь в разных городах. План C (Влияние): стипендия в топовом университете → программа социального предпринимательства → создание edtech-стартапа → работа в развивающихся странах → сочетание прибыли с целью. Оцените каждый 1-10 по: Ресурсы (могу ли я позволить это?), Привлекательность (вдохновляет ли меня это?), Уверенность (верю ли я, что смогу?), Согласованность (соответствует ли это моим ценностям?). Используйте оценки для направления исследования, а не для преждевременного исключения вариантов.",
            answerKk: "Мысал: A жоспары (Дәстүрлі): жергілікті университет → информатика дәрежесі → IT компаниясында тағылымдама → толық ставкалы бағдарламалық қамтамасыз ету инженері → қаладағы жеке пәтер. B жоспары (Шытырман): Еуропада шетелде оқу → Бизнес + Дизайн қос мамандығы → саяхаттай жүріп фриланс → дизайн агенттігін ашу → түрлі қалаларда өмір сүру. C жоспары (Әсер): үздік университетке стипендия → әлеуметтік кәсіпкерлік бағдарламасы → edtech стартап құру → дамушы елдерде жұмыс → пайданы мақсатпен ұштастыру. Әрқайсысын 1-10 бойынша бағалаңыз: Ресурстар (мұны көтере аламын ба?), Ұнату (бұл мені шабыттандыра ма?), Сенімділік (мұны істей аламын деп сенемін бе?), Сәйкестік (бұл құндылықтарыма сай келе ме?). Бағаларды нұсқаларды мезгілінен бұрын жоймай, зерттеуге бағыттау үшін пайдаланыңыз.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Сократите до максимум 3-4 инструментов: менеджер задач, календарь, приложение для заметок, школьная платформа. Освойте их глубоко вместо поверхностного использования 7 инструментов.",
            answerKk: "Ең көбі 3-4 құралға дейін қысқартыңыз: тапсырма менеджері, күнтізбе, жазба қолданбасы, мектеп платформасы. 7 құралды үстірт қолданудың орнына осыларды терең меңгеріңіз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Меньше инструментов означает меньше времени на переключение между приложениями, меньше когнитивной нагрузки на запоминание, где хранится информация, и более глубокое владение каждым инструментом. Много инструментов создают собственную нагрузку — вы тратите время на управление инструментами вместо работы.",
            answerKk: "Аз құрал қолданбалар арасында аз ауысу уақытын, ақпараттың қайда сақталғанын есте ұстаудың аз когнитивтік жүктемесін және әр құралды тереңірек меңгеруді білдіреді. Көп құралдар өз жүктемесін тудырады — жұмыс істеудің орнына құралдарды басқаруға уақыт жұмсайсыз.",
          ...
          },
          {
            ...
            answerRu: "1) Google Calendar (бесплатно, синхронизируется везде — для расписания, дедлайнов, встреч). 2) Todoist или Microsoft To Do (бесплатно — для ежедневных задач, отслеживания уроков, серий привычек). 3) Notion или Google Docs (бесплатно — для заметок, проектов, Второго мозга, черновиков заявок в вуз). 4) Google Drive (бесплатно — для резервного копирования и совместной работы). Почему: всё бесплатно, кроссплатформенно, синхронизируется в облаке и интегрируется друг с другом. Ученик может получить доступ ко всему с телефона, школьного компьютера или домашнего ноутбука.",
            answerKk: "1) Google Calendar (тегін, барлық жерде синхрондалады — сабақ кестесі, мерзімдер, кездесулер үшін). 2) Todoist немесе Microsoft To Do (тегін — күнделікті тапсырмалар, үй тапсырмасын бақылау, дағды сериялары үшін). 3) Notion немесе Google Docs (тегін — жазбалар, жобалар, Екінші ми, университет өтініштерінің жобалары үшін). 4) Google Drive (тегін — файлдарды сақтық көшірмелеу және бірлесіп жұмыс істеу үшін). Неге: барлығы тегін, кроссплатформалы, бұлтта синхрондалады және бір-бірімен интеграцияланады. Оқушы бәріне телефоннан, мектеп компьютерінен немесе үй ноутбугынан қол жеткізе алады.",
          ...
          },
          {
            ...
            answerRu: "Система: Notion (центр) + Google Calendar + Todoist + Anki. Поток: заметки уроков попадают в Notion с тегами по предметам. Ключевые понятия из Notion превращаются в карточки Anki для интервального повторения. Задания из Notion добавляются в Todoist со сроками. Сроки из Todoist синхронизируются с Google Calendar. Еженедельный обзор в Notion запускает: создание новых карточек Anki из свежих заметок, проверку просроченных задач в Todoist, просмотр календаря на предстоящие дедлайны. Система циклична: Учись (Notion) → Запоминай (Anki) → Выполняй (Todoist) → Планируй (Calendar) → Пересматривай (Notion). Автоматизация: сроки из Todoist автоматически появляются в календаре. Шаблоны Notion автоматически создают чек-листы задач для повторяющихся заданий.",
            answerKk: "Жүйе: Notion (орталық) + Google Calendar + Todoist + Anki. Ағын: сабақ жазбалары пән бойынша тегтелген күйде Notion-ға түседі. Notion-дағы негізгі ұғымдар аралықты қайталау үшін Anki карточкаларына айналады. Notion-дағы тапсырмалар мерзімдерімен Todoist-ке қосылады. Todoist мерзімдері Google Calendar-мен синхрондалады. Notion-дағы апталық шолу мыналарды іске қосады: соңғы жазбалардан жаңа Anki карточкаларын жасау, Todoist-те мерзімі өткен элементтерді тексеру, алдағы мерзімдер үшін күнтізбені қарау. Жүйе циклді: Үйрен (Notion) → Сақта (Anki) → Орында (Todoist) → Жоспарла (Calendar) → Шоли (Notion). Автоматтандыру: Todoist мерзімдері күнтізбеде автоматты пайда болады. Notion үлгілері қайталанатын тапсырмалар үшін тапсырма чек-парақтарын автоматты жасайды.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Шаблонные папки (дублировать еженедельно), синхронизация календаря для дедлайнов, автоматическое облачное резервное копирование, фильтры почты по учителям, повторяющиеся блоки календаря для учебных сессий.",
            answerKk: "Үлгі қалталар (апта сайын көшіру), мерзімдер үшін күнтізбе синхрондау, бұлтта автоматты сақтық көшірме, мұғалім бойынша пошта сүзгілері, оқу сеанстары үшін қайталанатын күнтізбе блоктары."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Если вы выполняете задачу более 3 раз, стоит потратить время на её автоматизацию. Вложенное вначале время окупается благодаря накопленной экономии за недели и месяцы.",
            answerKk: "Егер тапсырманы 3 реттен көп орындасаңыз, оны автоматтандыруға уақыт жұмсаған жөн. Алдын ала жұмсалған уақыт апталар мен айлар бойы жинақталған үнемдеу арқылы өтеледі.",
          ...
          },
          {
            ...
            answerRu: "1) Автофильтр: все письма от учителей → метка «Школа» + звёздочка, чтобы не пропустить важное. 2) Автофильтр: все рассылки/рекламные письма → метка «Прочитать позже», минуя входящие — проверять раз в неделю. 3) Автофильтр: все уведомления школьного портала → метка «Задания» с автопересылкой в менеджер задач. Общая экономия: без ручной сортировки (10 мин/день × 5 дней = 50 мин/неделю).",
            answerKk: "1) Автосүзгі: мұғалімдерден келген барлық хаттар → «Мектеп» белгісі + жұлдызша, маңызды хабарды жіберіп алмау үшін. 2) Автосүзгі: барлық жаршы/жарнамалық хаттар → «Кейін оқу» белгісі, кірісті айналып өту — аптасына бір рет тексеру. 3) Автосүзгі: мектеп порталының барлық хабарландырулары → тапсырма менеджеріне автоматты жіберілетін «Тапсырмалар» белгісі. Жалпы үнемдеу: қолмен сұрыптаусыз (күніне 10 мин × 5 күн = аптасына 50 мин).",
          ...
          },
          {
            ...
            answerRu: "Результаты аудита: сортировка почты (10 мин/день = 5 ч/месяц), еженедельная настройка папок (15 мин/неделю = 1 ч/месяц), проверка дедлайнов на разных платформах (10 мин/день = 5 ч/месяц), составление расписания учёбы (20 мин/неделю = 1,5 ч/месяц), резервное копирование файлов (15 мин/неделю = 1 ч/месяц). Общая потенциальная экономия: ~13,5 ч/месяц. Система: фильтры почты (автосортировка), шаблонная структура папок (дублировать еженедельно), синхронизация календаря со школьным порталом (автоимпорт дедлайнов), повторяющиеся блоки календаря (расписание «настроил и забыл»), автосинхронизация Google Drive (непрерывный бэкап). Внедрение: одна суббота днём (3 часа) на настройку всего. ROI: вложено 3 часа, экономится 13,5 часов в месяц — окупается за первую неделю.",
            answerKk: "Тексеру нәтижелері: пошта сұрыптау (күніне 10 мин = айына 5 сағ), апталық қалта баптау (аптасына 15 мин = айына 1 сағ), платформалар арасында мерзімдерді тексеру (күніне 10 мин = айына 5 сағ), оқу кестесін жасау (аптасына 20 мин = айына 1,5 сағ), файлдарды сақтық көшірмелеу (аптасына 15 мин = айына 1 сағ). Жалпы әлеуетті үнемдеу: айына ~13,5 сағ. Жүйе: пошта сүзгілері (автосұрыптау), үлгі қалта құрылымы (апта сайын көшіру), мектеп порталымен күнтізбе синхрондау (мерзімдерді автоимпорттау), қайталанатын күнтізбе блоктары («баптап, ұмыт» оқу кестесі), Google Drive автосинхрондау (үздіксіз сақтық көшірме). Іске асыру: бәрін баптауға бір сенбі түстен кейін (3 сағат). ROI: 3 сағат жұмсалды, айына 13,5 сағат үнемделеді — бірінші аптада өзін-өзі ақтайды.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Университет B (715) набирает наибольший балл во взвешенной матрице, балансируя хорошую учёбу с доступностью и разумным расстоянием.",
            answerKk: "B университеті (715) салмақталған матрицада ең жоғары ұпай жинайды, жақсы оқуды қолжетімділік пен қолайлы қашықтықпен теңестіреді."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "На интуицию влияют эмоции, предубеждения, недавний опыт и социальное давление. Фреймворки заставляют систематически учитывать все значимые факторы, взвешивать по-настоящему важное и делать логику решения видимой, чтобы её можно было пересмотреть и обосновать.",
            answerKk: "Ішкі сезімге эмоциялар, біржақтылықтар, соңғы тәжірибелер және әлеуметтік қысым әсер етеді. Фреймворктар барлық маңызды факторларды жүйелі түрде қарастыруға, шын мәнінде маңыздысын өлшеуге және таңдауыңызды қайта қарап, негіздей алуыңыз үшін пайымдауды көрінетін етуге мәжбүрлейді.",
          ...
          },
          {
            ...
            answerRu: "Тест обратимости: можно ли отменить каждый выбор? С подработки можно уволиться (обратимо). Пропущенный год кружков в 12 классе не вернуть (менее обратимо). Это в пользу кружков. Альтернативные издержки: работа даёт $200/неделю, но стоит 15 ч. Эти 15 ч в кружках могут дать опыт лидерства, уникальные навыки и более сильные заявки в вуз — что может привести к стипендиям на сумму намного больше $200/неделю. Решение: кружки, вероятно, имеют более высокую долгосрочную ценность, но рассмотрите меньшую подработку (5 ч/неделю), чтобы совместить оба варианта.",
            answerKk: "Кері қайтарымдылық тесті: әр таңдауды кері қайтаруға бола ма? Жартылай жұмыстан бас тартуға болады (қайтарымды). 12-сыныпта қосымша шараларды өткізіп алған жылды қайтару мүмкін емес (аз қайтарымды). Бұл қосымша шаралардың пайдасына. Мүмкіндік шығыны: жұмыс аптасына $200 береді, бірақ 15 сағат алады. Сол 15 сағатты қосымша шараларда өткізу көшбасшылық тәжірибесін, бірегей дағдыларды және күштірек университет өтініштерін бере алады — бұл $200/аптадан әлдеқайда көп стипендияға әкелуі мүмкін. Шешім: қосымша шаралардың ұзақ мерзімді құндылығы жоғарырақ, бірақ екеуін де қосу үшін кішірек жұмысты (аптасына 5 сағ) қарастырыңыз.",
          ...
          },
          {
            ...
            answerRu: "Pre-mortem для выбора Университета X: Возможные провалы: 1) Не смог оплатить обучение после 1 курса — профилактика: тщательно изучить финансовую помощь, иметь резервный план финансирования. 2) Возненавидел город/культуру — профилактика: посетить кампус, пообщаться со студентами до поступления. 3) Программа оказалась слабее ожидаемого — профилактика: проверить результаты недавних выпускников, а не только рейтинги. 4) Почувствовал изоляцию без системы поддержки — профилактика: изучить студенческие организации, посетить, найти сообщество заранее. 5) Изменились карьерные интересы, а университет слишком узкоспециализирован — профилактика: выбрать вуз с гибкими программами и лёгкой сменой специальности. Каждый выявленный риск становится профилактическим действием до принятия решения.",
            answerKk: "X университетін таңдауға pre-mortem: Мүмкін сәтсіздіктер: 1) 1-курстан кейін оқу ақысын төлей алмады — алдын алу: қаржылық көмекті мұқият зерттеу, қосалқы қаржыландыру жоспары болу. 2) Қала/мәдениетті жек көрді — алдын алу: түскенге дейін кампусқа бару, қазіргі студенттермен байланысу. 3) Бағдарлама күткеннен әлсіз болды — алдын алу: тек рейтингтерді емес, соңғы түлектердің нәтижелерін тексеру. 4) Қолдау жүйесінсіз оқшауланған сезінді — алдын алу: студенттік ұйымдарды зерттеу, бару, қауымдастықты ерте табу. 5) Мансап қызығушылығы өзгерді, ал университет тым мамандандырылған — алдын алу: икемді бағдарламалары мен мамандықты оңай ауыстыруға болатын университет таңдау. Анықталған әр тәуекел шешім қабылдамас бұрын алдын алу әрекетіне айналады.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Сократите до 28 сфокусированных часов в неделю, добавьте спорт, общение, хобби и дополнительный сон. Используйте техники продуктивности, чтобы меньшее число часов было эффективнее. Планируйте один полный день отдыха в неделю.",
            answerKk: "Аптасына 28 фокусталған сағатқа дейін қысқартыңыз, жаттығу, әлеуметтік уақыт, хобби және қосымша ұйқы қосыңыз. Аз сағатты тиімдірек ету үшін өнімділік техникаларын қолданыңыз. Аптасына бір толық демалыс күнін жоспарлаңыз."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Потому что истощение и выгорание снижают когнитивную деятельность. Отдохнувший мозг учится быстрее, лучше запоминает и мыслит яснее. Меньшее число качественных часов учёбы с достаточным сном, спортом и перерывами превосходит большее число часов в истощённом состоянии.",
            answerKk: "Себебі шаршау мен күйіп қалу когнитивтік өнімділікті төмендетеді. Демалған ми жылдамырақ үйренеді, жақсырақ есте сақтайды және анығырақ ойлайды. Жеткілікті ұйқымен, жаттығумен және үзілістермен аз, бірақ сапалы оқу сағаттары сарқылған күйдегі көп сағаттардан асып түседі.",
          ...
          },
          {
            ...
            answerRu: "Неприкосновенные пункты: 8 часов сна каждую ночь (без исключений). 30 минут спорта ежедневно (утром, до учёбы). Один приём пищи в день с семьёй/друзьями (общение). 1 час хобби/развлечений ежедневно (вечернее расслабление). Полный выходной в воскресенье ИЛИ субботу. Они блокируются в календаре как экзамены — их нельзя переносить. Учёба заполняет оставшиеся часы с использованием сфокусированных техник.",
            answerKk: "Талқыланбайтын пункттер: әр түні 8 сағат ұйқы (ерекшеліксіз). Күн сайын 30 минут жаттығу (таңертең, оқу алдында). Күніне отбасы/достармен бір тамақ (әлеуметтік байланыс). Күн сайын 1 сағат хобби/көңіл көтеру (кешкі демалу). Жексенбі НЕМЕСЕ сенбіде толық демалыс күні. Бұлар күнтізбеде емтихан сияқты блокталады — оларды жылжытуға болмайды. Оқу уақыты қалған сағаттарды фокусталған техникалармен толтырады.",
          ...
          },
          {
            ...
            answerRu: "Аргументы: 1) Недосып снижает GPA — исследования показывают, что каждый потерянный час сна снижает GPA на 0,1-0,2 балла, значит 5 ч сна могут стоить целого балла оценки. 2) Университеты предпочитают глубину, а не широту — 2-3 активности с лидерскими ролями впечатляют больше, чем 5 с поверхностным участием. 3) Риск выгорания высок — рухнуть до подачи заявок никому не поможет. План: используйте правило 80/20: какие 2-3 активности показывают больше всего лидерства и увлечённости? Оставьте их, откажитесь от остального или сократите. Сократите до 4-5 AP-курсов (всё ещё впечатляюще). Спите 7+ часов (неприкосновенно). Результат: лучшие оценки, более глубокая вовлечённость, более сильные заявки и устойчивый образ жизни.",
            answerKk: "Дәлел: 1) Ұйқы жетіспеушілігі GPA-ны төмендетеді — зерттеулер жоғалтқан әр ұйқы сағаты GPA-ны 0,1-0,2 балға түсіретінін көрсетеді, яғни 5 сағат ұйқы бір толық баллды құрдым етуі мүмкін. 2) Университеттер кеңдіктен гөрі тереңдікті қалайды — көшбасшылық рөлдері бар 2-3 шара беткейлі қатысатын 5-тен көбірек әсер қалдырады. 3) Күйіп қалу қаупі жоғары — өтініштер тапсырылмай тұрып құлау ешкімге пайда әкелмейді. Жоспар: 80/20 ережесін қолданыңыз: қай 2-3 шара ең көп көшбасшылық пен құмарлықты көрсетеді? Соларды қалдырыңыз, қалғанын тастаңыз немесе қысқартыңыз. 4-5 AP курсқа дейін қысқартыңыз (әлі де әсерлі). 7+ сағат ұйықтаңыз (талқыланбайды). Нәтиже: жақсырақ бағалар, тереңірек қатысу, күштірек өтініштер және тұрақты өмір салты.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Замените расплывчатые цели конкретными ежедневными действиями: 20 мин спорта ежедневно, 15 страниц перед сном, 200 слов каждое утро. Системы — это контролируемые процессы, делающие результат неизбежным.",
            answerKk: "Анық емес мақсаттарды нақты күнделікті әрекеттермен ауыстырыңыз: күн сайын 20 мин жаттығу, ұйықтар алдында 15 бет, әр таңертең 200 сөз. Жүйелер — нәтижені сөзсіз ететін бақыланатын процестер."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Цель — это желаемый результат (например, «сбросить 10 кг»). Система — это ежедневный процесс, которому вы следуете (например, «ходить 30 минут и есть овощи с каждым приёмом пищи»). Систему можно контролировать; цель зависит от факторов вне вашего контроля.",
            answerKk: "Мақсат — қалаған нәтиже (мысалы, «10 кг арықтау»). Жүйе — сіз ұстанатын күнделікті процесс (мысалы, «30 минут жүру және әр тамақпен көкөніс жеу»). Жүйені бақылауға болады; мақсат бақылауыңыздан тыс факторларға тәуелді.",
          ...
          },
          {
            ...
            answerRu: "Ежедневная система: 1) 3 сфокусированных часа учёбы с активным воспроизведением (поддерживает GPA). 2) 20 минут на подготовку к SAT/ACT. 3) Чтение 15 страниц (расширяет словарный запас и знания). Еженедельная система: 4) 2 часа на лидерские внеклассные активности. 5) 1 час на написание/правку эссе. 6) 30-минутная сессия исследования вузов. Ежемесячно: 7) Встреча с консультантом. 8) Завершение одного раздела заявки. Ежедневная система, если ей следовать постоянно, делает цель почти неизбежной.",
            answerKk: "Күнделікті жүйе: 1) Белсенді еске түсірумен 3 фокусталған сағат оқу (GPA сақтайды). 2) SAT/ACT дайындығына 20 минут. 3) 15 бет оқу (сөздік қор мен білімді кеңейтеді). Апталық жүйе: 4) Көшбасшылық қосымша шараларға 2 сағат. 5) Эссе жазу/түзетуге 1 сағат. 6) Университетті зерттеу сеансына 30 минут. Айлық: 7) Кеңесшімен кездесу. 8) Өтініштің бір бөлімін аяқтау. Тұрақты орындалатын күнделікті жүйе мақсатты дерлік сөзсіз етеді.",
          ...
          },
          {
            ...
            answerRu: "Утренняя система: подъём в 6:30, стыковка привычек (заправить кровать → вода → растяжка → обзор приоритетов → 30-мин глубокая работа). Ежедневная система: расписание с блокировкой времени и картой энергии (сложные задачи на пике, лёгкие — при низкой энергии). Автоматизация обрабатывает: фильтры почты, повторяющиеся блоки календаря, облачные бэкапы, напоминания о заданиях. Еженедельная система: воскресный 45-минутный обзор — очистка входящих (GTD), обзор проектов, планирование блоков следующей недели, обновление партнёра по подотчётности. Ежемесячная система: обзор SMART-целей, проверка прогресса семестрового плана, корректировка квартальных целей, архивирование завершённых проектов. Отслеживание привычек: календарь серий для основных ежедневных привычек. Подотчётность: еженедельная проверка с учебным партнёром, ежемесячная с наставником. Ключевая идея: каждый компонент усиливает остальные. Привычки делают ежедневное выполнение автоматическим. Блокировка времени гарантирует выполнение нужной работы. Управление энергией максимизирует отдачу каждого часа. Автоматизация устраняет трение. Подотчётность предотвращает отклонение от курса. Обзоры поддерживают согласованность всего.",
            answerKk: "Таңғы жүйе: 6:30-да ояну, дағды тізбегі (төсекті жинау → су → созылу → басымдықтарды қарау → 30 мин терең жұмыс). Күнделікті жүйе: энергия картасы бар уақыт блоктау кестесі (қиын тапсырмалар шыңда, жеңіл тапсырмалар төмен энергияда). Автоматтандыру мыналарды өңдейді: пошта сүзгілері, қайталанатын күнтізбе блоктары, бұлттық сақтық көшірмелер, тапсырма еске салғыштары. Апталық жүйе: жексенбілік 45 минуттық шолу — кірістерді тазалау (GTD), жобаларды қарау, келесі апта блоктарын жоспарлау, есеп беру серіктесін жаңарту. Айлық жүйе: SMART мақсаттарды қарау, семестр жоспарының прогресін тексеру, тоқсандық мақсаттарды түзету, аяқталған жобаларды мұрағаттау. Дағды бақылауы: негізгі күнделікті дағдылар үшін серия күнтізбесі. Есеп беру: оқу серіктесімен апта сайын, тәлімгермен ай сайын тексеру. Негізгі түсінік: әр компонент басқаларын нығайтады. Дағдылар күнделікті орындауды автоматты етеді. Уақытты блоктау дұрыс жұмыстың орындалуын қамтамасыз етеді. Энергияны басқару әр сағаттың нәтижесін барынша арттырады. Автоматтандыру кедергілерді жояды. Есеп беру ауытқуды болдырмайды. Шолулар бәрін сәйкестікте ұстайды.",
        ...
        solvedExamples: [
          {
            ...
            answerRu: "Три ежедневные/квартальные привычки обучения, отобранные источники информации, учебное сообщество и обучение других тому, что вы изучили, для углубления понимания.",
            answerKk: "Үш күнделікті/тоқсандық оқу дағдысы, іріктелген ақпарат көздері, оқу қауымдастығы және түсінуді тереңдету үшін үйренгеніңізді басқаларға үйрету."
          }
        ],
        practiceProblems: [
          {
            ...
            answerRu: "Потому что знания быстро устаревают — технологии, отрасли и требования к работе постоянно меняются. Тот, кто быстро учится, может адаптироваться к любым изменениям, а тот, у кого фиксированные знания, устаревает. Метаобучение (умение учиться) — главный навык.",
            answerKk: "Себебі білім тез ескіреді — технологиялар, салалар және жұмыс талаптары үнемі өзгереді. Тез үйренетін адам кез келген өзгеріске бейімделе алады, ал тұрақты біліммен адам ескіреді. Мета-оқу (қалай үйрену керектігін үйрену) — ең маңызды дағды.",
          ...
          },
          {
            ...
            answerRu: "Навык: базовая веб-разработка. Месяц 1: ежедневные 45-минутные блоки обучения, вводный курс, создание простых страниц по памяти. Месяц 2: создание 3 проектов возрастающей сложности, техника Фейнмана, присоединение к сообществу. Месяц 3: создание реального проекта для портфолио, обучение других тому, что изучили. На протяжении всего периода: блокировка времени, интервальное повторение, подотчётность и еженедельные обзоры.",
            answerKk: "Дағды: веб-әзірлеудің негіздері. 1-ай: күнделікті 45 минуттық оқу блоктары, кіріспе курс, жадыдан қарапайым беттер жасау. 2-ай: күрделілігі артатын 3 жоба жасау, Фейнман техникасын қолдану, қауымдастыққа қосылу. 3-ай: нақты портфолио жобасын жасау, үйренгенін үйрету. Барлық кезеңде: уақытты блоктау, аралықты қайталау, есеп беру және апталық шолулар қолданылады.",
          ...
          },
          {
            ...
            answerRu: "Пример структуры письма: «Дорогой будущий Я: вот системы, которые я обязуюсь поддерживать: 1) Система PKM в Notion — захват ежедневно, обработка еженедельно, обзор ежемесячно (из PKM + Второй мозг). 2) Ежедневная привычка обучения: 30 мин чтения + 15 мин Anki (из Интервального повторения + Формирования привычек). 3) Квартальные спринты навыков: изучение одного нового навыка каждые 3 месяца блоками глубокой работы (из Глубокой работы + Годового планирования). 4) Еженедельный обзор GTD: каждое воскресенье очищать входящие и планировать неделю (из GTD + Планирования семестра). 5) Расписание с учётом энергии: сложная творческая работа утром, рутинные задачи после обеда (из Управления энергией + Блокировки времени). 6) Ежегодное обновление плана Одиссеи: пересматривать 3 жизненных пути каждый год (из Проектирования жизни). 7) Обучать других тому, что изучил: вести блог, наставничество или репетиторство регулярно (из Техники Фейнмана + Непрерывного обучения). Привычки, которые я буду защищать: 8 часов сна, ежедневный спорт, еженедельное общение, один день отдыха. Они неприкосновенны, потому что устойчивая продуктивность требует восстановления (из Баланса работы и жизни). Помни: системы побеждают цели, постоянство побеждает интенсивность, а накопительный эффект ежедневного обучения — необычаен.»",
            answerKk: "Хат құрылымының мысалы: «Құрметті Болашақ Мен: мен сақтауға уәде беретін жүйелер: 1) Notion-дағы PKM жүйесі — күн сайын түсіру, апта сайын өңдеу, ай сайын шолу (PKM + Екінші миден). 2) Күнделікті оқу дағдысы: 30 мин оқу + 15 мин Anki (Аралықты қайталау + Дағды қалыптастырудан). 3) Тоқсандық дағды спринттері: терең жұмыс блоктарымен әр 3 айда бір жаңа дағды үйрену (Терең жұмыс + Жылдық жоспарлаудан). 4) Апталық GTD шолуы: әр жексенбіде кірістерді тазалау және аптаны жоспарлау (GTD + Семестрді жоспарлаудан). 5) Энергияға оңтайландырылған кесте: таңертең қиын шығармашылық жұмыс, түскі астан кейін тұрақты тапсырмалар (Энергияны басқару + Уақытты блоктаудан). 6) Одиссей жоспарын жыл сайын жаңарту: әр жылы 3 өмір жолымды қайта қарау (Өмірді жобалаудан). 7) Үйренгенімді үйрету: блог жүргізу, тәлімгерлік немесе репетиторлық тұрақты түрде (Фейнман техникасы + Өмір бойы оқудан). Мен қорғайтын дағдылар: 8 сағат ұйқы, күнделікті жаттығу, апта сайын әлеуметтік байланыс, бір демалыс күні. Бұлар талқыланбайды, себебі тұрақты өнімділік қалпына келтіруді талап етеді (Жұмыс-өмір балансынан). Есте сақта: жүйелер мақсаттарды жеңеді, тұрақтылық қарқындылықты жеңеді, және күнделікті оқудың жинақталған әсері ерекше.»",
