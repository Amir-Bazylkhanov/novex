// ============================================
// Учебный контент планеты «Psychology & Social Intelligence» (психология и
// социальный интеллект) — готовый учебный курс Академии Novex.
// Подключается в constants/academy/catalog.ts
// как одна из планет и показывается на странице /learn для
// соответствующего робота-наставника.
// Одна запись = один класс (ключ вида
// "Psychology & Social Intelligence_8"..._12): введение + список секций,
// где у каждой секции — теория на трёх языках, формулы, термины,
// разобранные примеры и практические задачи.
// ============================================
