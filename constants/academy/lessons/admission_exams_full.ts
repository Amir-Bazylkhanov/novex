// ============================================
// Учебный контент планеты «Admission Exams» (подготовка к вступительным
// экзаменам: SAT/ACT/IELTS/TOEFL) — готовый учебный курс Академии Novex.
// Подключается в constants/academy/catalog.ts как
// одна из планет и показывается на странице /learn для соответствующего
// робота-наставника.
// Одна запись = один класс (ключ вида "Admission Exams_8"..._12): введение +
