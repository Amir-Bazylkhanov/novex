...
// ============================================
// Банк вопросов диагностики по предмету «Английский язык».
...
// проще). Сами вопросы даны на английском языке во всех трёх переводах
// (так и задумано — это упражнения по английскому). Файл отсортирован
// от лёгких вопросов к сложным.
