...
// ============================================
// ДЕМО-данные для панели учителя: список учеников «виртуального класса», их
// оценки по предметам, слабые темы и статистика класса за неделю. Это не
// настоящие данные из базы — в проекте пока нет таблицы классов, поэтому
// учитель видит эту заготовку с пометкой «Демо-данные класса». Все цифры
// подобраны согласованно: needsHelp = true ровно у тех, чей средний балл
// ниже 55, а слабые темы соответствуют самым низким оценкам ученика.
// ============================================
/**
